 ...
 * @return  None
 */
STATIC INLINE void Chip_SDIF_SetBlkSize(LPC_SDMMC_Type *pSDMMC, uint32_t bytes)
{
    pSDMMC->BLKSIZ = bytes;
}
 ...
 */
STATIC INLINE void Chip_SDIF_Reset(LPC_SDMMC_Type *pSDMMC, int32_t reset)
{
    if (reset) {
        pSDMMC->RST_N = 1;
    }
 ...
 */
STATIC INLINE int32_t Chip_SDIF_CardNDetect(LPC_SDMMC_Type *pSDMMC)
{
 ...
 */
STATIC INLINE int32_t Chip_SDIF_CardWpOn(LPC_SDMMC_Type *pSDMMC)
{
 ...
 */
STATIC INLINE void Chip_SDIF_PowerOff(LPC_SDMMC_Type *pSDMMC)
{
    pSDMMC->PWREN = 0;
}
 ...
 */
STATIC INLINE void Chip_SDIF_PowerOn(LPC_SDMMC_Type *pSDMMC)
{
    pSDMMC->PWREN = 1;
}
 ...
 * @return  None
 */
STATIC INLINE void Chip_SDIF_SetCardType(LPC_SDMMC_Type *pSDMMC, uint32_t ctype)
{
    pSDMMC->CTYPE = ctype;
}
 ...
 */
STATIC INLINE uint32_t Chip_SDIF_GetIntStatus(LPC_SDMMC_Type *pSDMMC)
{
 ...
 * @return  None
 */
STATIC INLINE void Chip_SDIF_ClrIntStatus(LPC_SDMMC_Type *pSDMMC, uint32_t iVal)
{
    pSDMMC->RINTSTS = iVal;
}
 ...
 * @return  None
 */
STATIC INLINE void Chip_SDIF_SetIntMask(LPC_SDMMC_Type *pSDMMC, uint32_t iVal)
{
    pSDMMC->INTMASK = iVal;
}
 ...
 * @return  None
 */
STATIC INLINE void Chip_SDIF_SetBlkSizeByteCnt(LPC_SDMMC_Type *pSDMMC, uint32_t blk_size)
{
 ...
 * @return  None
 */
STATIC INLINE void Chip_SDIF_SetByteCnt(LPC_SDMMC_Type *pSDMMC, uint32_t bytes)
{
    pSDMMC->BYTCNT = bytes;
}
 ...
 * @return  None
 */
void Chip_SDIF_Init(LPC_SDMMC_Type *pSDMMC);
 ...
 * @return  None
 */
void Chip_SDIF_DeInit(LPC_SDMMC_Type *pSDMMC);
 ...
 */
int32_t Chip_SDIF_SendCmd(LPC_SDMMC_Type *pSDMMC, uint32_t cmd, uint32_t arg);
 ...
 * @return  None
 */
void Chip_SDIF_GetResponse(LPC_SDMMC_Type *pSDMMC, uint32_t *resp);
 ...
 * @return  None
 */
void Chip_SDIF_SetClock(LPC_SDMMC_Type *pSDMMC, uint32_t clk_rate, uint32_t speed);
 ...
 * @return  None
 */
void Chip_SDIF_SetClearIntFifo(LPC_SDMMC_Type *pSDMMC);
 ...
 * @return  None
 */
void Chip_SDIF_DmaSetup(LPC_SDMMC_Type *pSDMMC, sdif_device *psdif_dev, uint32_t addr, uint32_t size);
